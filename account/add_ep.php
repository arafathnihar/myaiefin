                                ...
                                <div class="panel-body">
                                    ...
                                    <form class='form-horizontal' role='form' name='addEP' action='' method='post'>
                                        <div class="form-group">
                                            ...
                                            <label for="ID" class="col-sm-4 control-label">Income ID</label>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="radio" name="stat" value="paid">Received &nbsp;&nbsp;&nbsp;&nbsp;
                                                <input type="radio" name="stat" value="payable">Receivable
                                            </div>
                                        </div>
                            ...
                            <div class="panel-body">
                                <div class="panel-body">
                                    ...
                                    <form class='form-horizontal' role='form' name='addEP' action='' method='post'>
                                        ...
                                        <div class="form-group">
                                            <label for="sup" class="col-sm-4 control-label">Supportings</label>
                                            <div class="col-sm-8">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class='form-horizontal' role='form' name='addEP' action='' method='post'>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="inputEpId" class="col-sm-4 control-label"> Event ID </label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="inputEpName" class="col-sm-4 control-label">Budgeted Expense(LKR)</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="inputEpName" class="col-sm-4 control-label">Actual Expense(LKR)</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="inputEpName" class="col-sm-4 control-label">Actual Income(LKR)</label>
